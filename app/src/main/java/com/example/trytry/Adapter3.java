...
public class Adapter3 extends RecyclerView.Adapter<Adapter3.ViewHolder> {
    Context context;
    private List<ModelClass3> userlist;
    private SelectListener3 listener;

    public Adapter3(List<ModelClass3> userlist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_design3, parent, false);

        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter3.ViewHolder holder, int p) {
        int resource = userlist.get(p).getreptile1pic();
        ...
        holder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("image",userlist.get(p).getreptile1pic());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            dog1pic=itemView.findViewById(R.id.reptile1pic);
