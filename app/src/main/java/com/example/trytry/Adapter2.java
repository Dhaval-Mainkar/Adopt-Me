...
public class Adapter2 extends RecyclerView.Adapter<Adapter2.ViewHolder> {
    Context context;
    private List<ModelClass2> userlist;
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter2.ViewHolder holder,int p) {
        int resource = userlist.get(p).getcat1pic();
        ...
        holder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("image",userlist.get(p).getcat1pic());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            dog1pic=itemView.findViewById(R.id.cat1pic);
